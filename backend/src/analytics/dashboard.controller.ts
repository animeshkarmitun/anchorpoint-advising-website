...
export class DashboardController {
  ...
  @ApiOperation({
    ...
    description:
      'Total customers, active filings, revenue, pending docs, open tickets with MoM change.',
  })
  ...
  @Get('customer-growth')
  @ApiOperation({
    summary: 'Customer growth chart',
    description: 'Monthly new signups and cumulative total.',
  })
  ...
  @ApiOperation({
    summary: 'Filing performance report',
    description: 'By status, type, advisor, and average processing time.',
  })
