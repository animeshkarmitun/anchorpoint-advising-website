...
export class DocumentsController {
  ...
  @ApiOperation({
    ...
    description:
      'List all documents uploaded by the authenticated user. Supports filtering and pagination.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns a URL to download the document. URL expires in 15 minutes.',
  })
  ...
  @ApiResponse({
    status: 400,
    description: 'Document not eligible for re-upload',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Delete a pending or rejected document. Accepted documents cannot be deleted.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Document checklist with completion rate',
  })
  async getChecklist(
    @CurrentUser('id') userId: string,
