...
export class AdminFilingsController {
  ...
  @ApiOperation({
    ...
    description:
      'List all customer filings with filtering by status, year, type, and advisor.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns total filings, breakdown by status and type, active and completed counts.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Full filing details including customer profile, documents, and status history.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Assign a TAX_ADVISOR to a filing. Both customer and advisor are notified.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update income, tax payable/paid, refund amount, deadline, and internal notes.',
  })
