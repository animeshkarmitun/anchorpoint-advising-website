...
export class AuthController {
  ...
  @ApiResponse({
    status: 403,
    description: 'Registration is disabled or invite required',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Resets the password using the token received via email. Token is single-use and expires in 30 minutes.',
  })
