...
export class AdminTicketsController {
  ...
  @ApiOperation({
    ...
    description: 'Priority-sorted ticket queue.',
  })
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Ticket details (admin)',
    description: 'Includes internal notes.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Change status, priority, or assignment.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Can include internal notes.',
  })
