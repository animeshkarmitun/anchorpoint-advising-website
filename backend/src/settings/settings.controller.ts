...
export class SettingsController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns the current registration mode (OPEN, INVITE_ONLY, DISABLED) and active invites.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new invite link for INVITE_ONLY mode. Configure max uses and expiry.',
  })
