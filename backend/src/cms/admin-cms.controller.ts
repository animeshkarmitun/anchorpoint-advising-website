...
export class AdminCmsController {
  ...
  @Put(':section')
  @ApiOperation({
    summary: 'Create or update CMS section',
    description: 'Upserts section content with audit logging.',
  })
  ...
  async upsert(
    ...
    return this.cmsService.upsertSection(
      section,
      locale || 'en',
      body.data,
      adminId,
  ...
  @ApiOperation({
    ...
    description: 'Reverts to default content from JSON files.',
  })
  @ApiQuery({ name: 'locale', required: false, example: 'en' })
