...
export class PaymentsController {
  ...
  @ApiOperation({
    ...
    description:
      'Start a payment for a filing or consultation. Supports coupon codes.',
  })
  ...
  @ApiOperation({
    ...
    description: 'List all payments with total spent.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Request refund for a completed payment.',
  })
